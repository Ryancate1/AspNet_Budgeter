    ...
    public class AccountController : Universal
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Reset Password", "This message was sent from ROC Financial Portal.  To reset your password by clicking <a href=\"" + callbackUrl + "\">here</a>.  If you did not request this emaiil, please delete it immediately.");
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("UnauthorizedIndex", "Home");
        }
        ...
        private async Task InviteToJoin(ApplicationUser user)
        {
            string code = await UserManager.GeneratePasswordResetTokenAsync(user.Id);
            //relative URL vs absolute URL
            var callbackUrl = Url.Action("ResetPassword", "Account", new { userId = user.Id, code = code }, protocol: Request.Url.Scheme);
            await UserManager.SendEmailAsync(user.Id, "Don't be homeless!", body: "You have been invited to join a House-hold! To join, click <a href=\"" + callbackUrl + "\">here</a> and your journey will begin!");
        }
